		...
		<div id="content">
			...
			<div class="container" style="margin-top: 20px;">
				<div class="card shadow">
					...
					<div class="card-body">
						<form action="<?php echo base_url('proses_tambah_penduduk')?>" method="post">
							<div class="form-group">
								<label><b>NIK</b></label>
								<input type="text" name="nik" class="form-control" id="" placeholder="Masukan NIK">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="number" name="usia" class="form-control" id="" placeholder="Masukan Usia">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" name="pekerjaan" class="form-control" id="" placeholder="Masukan Pekerjaan">
							</div>
							<div class="form-group">
